...
namespace NSE.Pedidos.API.Application.Commands
{
        ...
        IRequestHandler<AdicionarPedidoCommand, ValidationResult>
    {
        ...
        {
            var pedidoInciiado = new PedidoIniciadoIntegrationEvent
            {
                PedidoId = pedido.Id,
                ClienteId = pedido.ClienteId,
                Valor = pedido.ValorTotal,
                TipoPagamento = 1, //fixo. Altear se tiver mais tipo (nova feature)
            ...
            var result = await _bus.RequestAsync<PedidoIniciadoIntegrationEvent, ResponseMessage>(pedidoInciiado);
